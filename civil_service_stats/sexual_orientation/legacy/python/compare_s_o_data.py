...
# %%
# Set filepaths
EXCEL_PATH = "C:/Users/" + os.getlogin() + "/INSTITUTE FOR GOVERNMENT/Data - General/Civil service/Civil Service - diversity/Civil Service - sexual orientation/Sexual orientation of civil servants.xlsx"
SHEET_NAME = "Data.CollatedOrientationbyDept"
SQL_PATH = "C:/Users/" + os.getlogin() + "/INSTITUTE FOR GOVERNMENT/Data - General/Civil service/Civil Service Statistics/Scripts/civil_service_stats/sexual_orientation/legacy/compare_s_o_organisations_data"
...
key_cols = ["Year", "Quarter", "Organisation", "Sexual orientation", "Headcount"]
